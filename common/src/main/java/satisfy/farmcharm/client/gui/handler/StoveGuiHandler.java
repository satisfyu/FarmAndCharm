...
import satisfy.farmcharm.client.gui.handler.slot.StoveOutputSlot;
import satisfy.farmcharm.client.recipebook.custom.StoveRecipeBookGroup;
import satisfy.farmcharm.recipe.StoveRecipe;
