...
import satisfy.farmcharm.block.CraftingBowlBlock;
import satisfy.farmcharm.client.model.CraftingBowlModel;
import satisfy.farmcharm.entity.CraftingBowlBlockEntity;
...
public class CraftingBowlRenderer implements BlockEntityRenderer<CraftingBowlBlockEntity> {
    ...
    public void render(CraftingBowlBlockEntity blockEntity, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j) {
        ...
        ResourceLocation location = blockEntity.getItem(4) == ItemStack.EMPTY ?
                new ResourceLocation(FarmCharm.MOD_ID, "textures/entity/crafting_bowl.png") :
                new ResourceLocation(FarmCharm.MOD_ID, "textures/entity/crafting_bowl_full.png");
