...
public class PlowModel<T extends CartEntity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cart = partdefinition.addOrReplaceChild("cart", CubeListBuilder.create().texOffs(116, 8).addBox(-11.0F, 1.5F, 5.9167F, 22.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(88, 0).addBox(-8.0F, 2.5F, 9.9167F, 3.0F, 3.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.5F, 10.0833F));

        PartDefinition plow_r1 = cart.addOrReplaceChild("plow_r1", CubeListBuilder.create().texOffs(173, 61).addBox(-25.0F, 5.0F, -7.0F, 16.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -12.0F, 0.0F, -0.7854F, 0.0F));

        PartDefinition plow_r2 = cart.addOrReplaceChild("plow_r2", CubeListBuilder.create().texOffs(173, 61).mirror().addBox(7.0F, 5.0F, -9.0F, 16.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, -12.0F, 0.0F, 0.7854F, 0.0F));

        PartDefinition plow_r3 = cart.addOrReplaceChild("plow_r3", CubeListBuilder.create().texOffs(173, 61).addBox(-25.0F, 5.0F, -7.0F, 16.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.0F, -0.7854F, 0.0F));

        PartDefinition plow_r4 = cart.addOrReplaceChild("plow_r4", CubeListBuilder.create().texOffs(173, 61).mirror().addBox(7.0F, 5.0F, -9.0F, 16.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.0F, 0.7854F, 0.0F));
