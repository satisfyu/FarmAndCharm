...
public class CartModel<T extends CartEntity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cart = partdefinition.addOrReplaceChild("cart", CubeListBuilder.create()
                .texOffs(88, 0).addBox(5.0F, 1.5F, 9.9167F, 3.0F, 3.0F, 18.0F)
                .texOffs(88, 0).addBox(-8.0F, 1.5F, 9.9167F, 3.0F, 3.0F, 18.0F)
                .texOffs(0, 43).addBox(-12.0F, -7.5F, -30.0833F, 3.0F, 9.0F, 32.0F)
                .texOffs(0, 43).mirror().addBox(9.0F, -7.5F, -30.0833F, 3.0F, 9.0F, 32.0F).mirror(false)
                .texOffs(88, 21).addBox(-9.0F, -7.5F, -1.0833F, 18.0F, 9.0F, 3.0F)
                .texOffs(0, 0).addBox(-12.0F, 1.5F, -30.0833F, 24.0F, 3.0F, 40.0F), PartPose.offset(0.0F, 12.5F, 10.0833F));

        PartDefinition chest_lid = cart.addOrReplaceChild("chest_lid", CubeListBuilder.create()
                .texOffs(0, 111).addBox(-7.0F, 1.0F, -7.0F, 14.0F, 5.0F, 14.0F)
                .texOffs(0, 111).addBox(-1.0F, 3.0F, -8.0F, 2.0F, 4.0F, 1.0F), PartPose.offset(0.0F, -13.5F, -10.0833F));

        PartDefinition chest = cart.addOrReplaceChild("chest", CubeListBuilder.create()
                .texOffs(0, 130).addBox(-7.0F, -16.0F, -7.0F, 14.0F, 10.0F, 14.0F), PartPose.offset(0.0F, 7.5F, -10.0833F));

        PartDefinition right_wheel = partdefinition.addOrReplaceChild("right_wheel", CubeListBuilder.create()
                .texOffs(76, 43).addBox(-1.5F, -8.0F, -8.0F, 3.0F, 16.0F, 16.0F), PartPose.offset(10.0F, 10.0F, 0.0F));

        PartDefinition left_wheel = partdefinition.addOrReplaceChild("left_wheel", CubeListBuilder.create()
                .texOffs(76, 43).mirror().addBox(-1.5F, -8.0F, -8.0F, 3.0F, 16.0F, 16.0F).mirror(false), PartPose.offset(-10.0F, 10.0F, 0.0F));
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float wheelRotation = entity.wheelRot();
