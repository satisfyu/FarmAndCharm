...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> BAKED_LAMB_HAM = registerWithoutItem("baked_lamb_ham_block", () -> new FoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 3, new FoodProperties.Builder().nutrition(8).saturationMod(0.9F).build()));
    public static final RegistrySupplier<Block> FARMERS_BREAKFAST = registerWithoutItem("farmers_breakfast_block", () -> new FoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 3, new FoodProperties.Builder().nutrition(12).saturationMod(1.2F).build()));
    public static final RegistrySupplier<Block> STUFFED_CHICKEN = registerWithoutItem("stuffed_chicken_block", () -> new FoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 3, new FoodProperties.Builder().nutrition(8).saturationMod(0.8F).build()));
    public static final RegistrySupplier<Block> STUFFED_RABBIT = registerWithoutItem("stuffed_rabbit_block", () -> new FoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 3, new FoodProperties.Builder().nutrition(9).saturationMod(0.9F).build()));
    public static final RegistrySupplier<Block> GRANDMOTHERS_STRAWBERRY_CAKE = registerWithoutItem("grandmothers_strawberry_cake_block", () -> new FoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 3, new FoodProperties.Builder().nutrition(7).saturationMod(0.6F).build()));
    public static final RegistrySupplier<Block> FARMERS_BREAD = registerWithoutItem("farmers_bread_block", () -> new FoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 3, new FoodProperties.Builder().nutrition(6).saturationMod(0.8F).build()));
